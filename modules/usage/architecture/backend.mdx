...
description: "<div style={{ textAlign: 'center' }}<CodeGroup>
```
<img src="https://github.com/All-Hands-AI/OpenHands/assets/16201837/97d747e3-29d8-4ccb-8d34-6ad1adb17f38" a..."
---
```
</CodeGroup>

<div style={{ textAlign: 'center' }}<CodeGroup>
```
...
<Accordion title="Updating this Diagram"<CodeGroup>
```
<div>
...
1.  Autogenerate the diagram by running the following command from the root of the repository:
    `py2puml openhands openhands <CodeGroup>
```
