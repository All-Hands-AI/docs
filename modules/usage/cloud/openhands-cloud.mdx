...
description: "OpenHands Cloud is the cloud hosted version of OpenHands by All Hands AI."
---
...
You can also interact with OpenHands Cloud programmatically using the [API](/modules/usage/cloud-api).
...
2. Select the organization, then choose the specific repositories to grant OpenHands access to.
   <Accordion title="Permission Details for Repository Access"<CodeGroup>
```
